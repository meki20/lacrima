...
export default async function Settings() {
  ...
  return <><TopBar active="Settings" /><main className="settings-page">
    ...
    <BackupTransfer kind="profile" title="Profile backup" description="Your library, progress, playback settings, subtitle choices, stickers and their positions." importNote="Import replaces this profile’s saved data." />
